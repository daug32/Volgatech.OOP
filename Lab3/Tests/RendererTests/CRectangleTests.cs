...
public class CRectangleTests
{
    ...
    public void Area_RectangleWithWidth4AndHeight5_ExpectAreaToBe20()
    {
        // Arrange
        float expected = 20;
        ICRectangle rect = new CRectangle( 4, 5, Vector2.Zero );
    ...
    public void Perimeter_RectangleWithWidth4AndHeight5_ExpectPerimeterToBe18()
    {
        // Arrange
        float expected = 18;
        ICRectangle rect = new CRectangle( 4, 5, Vector2.One );
    ...
    public void Move_RectangleIsMovedBy30AtHorizontalAxes_RectanglesLeftPointIsMovedToo()
    {
        ...
        ICRectangle rect = new CRectangle( 10, 10, Vector2.Zero );
    ...
    public void SetScale_RectangleWithWidth4AndHeight5ScaledByTwoAtEachDirection_NewWidthIs8AndHeightIs10()
    {
        ...
        var rect = new CRectangle( width, height, Vector2.Zero );
    ...
    {
        // Arrange
        var rect = new CRectangle( 2, 10, Vector2.Zero );
    ...
    {
        // Arrange
        ICRectangle rect1 = new CRectangle( 4, 5, Vector2.Zero );
        ICRectangle rect2 = new CRectangle( 2, 3, Vector2.Zero );
    ...
    public void Intersect_RectanglesThatDontIntersect_ReturnsFalse()
    {
        // Arrange
        ICRectangle rect1 = new CRectangle( 4, 5, Vector2.Zero );
        ICRectangle rect2 = new CRectangle( 2, 3, new Vector2( 100 ) );
